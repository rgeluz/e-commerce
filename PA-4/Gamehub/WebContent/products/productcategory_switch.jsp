          ...
          <div class="product-table">
            <table>
              ...
              <tbody>
				...
				<%
					//ADD PRODUCT CARDS
			        ArrayList<Map<String, Object>> productList = EcommerceAPIService.getAllProductsByCategory("Nintendo Switch"); //Database.getAllProductsByCategory("Nintendo Switch");
					int i=0;
					for(Map<String, Object> product : productList) {
						...
						String mainImage = imageLinksArray[0];
						  ...
						  out.println("<td>\n" +
		               "<div class=\"productcategory-card\">\n" +
		                 "<a href=\"productdetails.jsp?pageFrom=productcategory_switch.jsp&productCategory="+product.get("ProductCategory")+"&productID="+product.get("ProductID")+"\">\n" +
