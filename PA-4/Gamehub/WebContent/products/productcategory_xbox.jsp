    ...
    <div class="main-container">
      ...
      <section>
        <div class="main">
          ...
          <!--<p>Xbox One Products</p>
          <p>//add xbox one products</p>
            ...
            <table>
              ...
              <tbody>
                ...
                <!-- <?php
                  ...
                  $products = getAllProductsByCategory("Xbox One");
                    ...
                    echo "
                            <td>
                              <div class='productcategory-card'>
                                <a href='productdetails.php?pageFrom=productcategory_xbox.php&productCategory=".$product['ProductCategory']."&productID=".$product['ProductID']."'>
				...
				<%
			   		...
			   		//ADD PRODUCT CARDS
			        ArrayList<Map<String, Object>> productList = EcommerceAPIService.getAllProductsByCategory("Xbox One"); //Database.getAllProductsByCategory("Xbox One");
			        int i=0;
					for(Map<String, Object> product : productList) {	
						...
						String mainImage = imageLinksArray[0];
						  ...
						  out.println("<td>\n" +
		               "<div class=\"productcategory-card\">\n" +
		               "<a href=\"productdetails.jsp?pageFrom=productcategory_xbox.jsp&productCategory="+product.get("ProductCategory")+"&productID="+product.get("ProductID")+"\">\n" +
