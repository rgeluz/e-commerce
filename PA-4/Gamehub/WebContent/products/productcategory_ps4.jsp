            ...
            <table>
              ...
              <tbody>
                ...
                <!-- <?php
                  ...
                  $products = getAllProductsByCategory("PlayStation 4");
                    ...
                    echo "
                            <td>
                              <div class='productcategory-card'>
                                <a href='productdetails.php?pageFrom=productcategory_ps4.php&productCategory=".$product['ProductCategory']."&productID=".$product['ProductID']."'>
				...
				<%
					//ADD PRODUCT CARDS
			   		ArrayList<Map<String, Object>> productList = Database.getAllProductsByCategory("PlayStation 4");
					int i=0;
					for(Map<String, Object> product : productList) {
						...
						String mainImage = imageLinksArray[0];
						  ...
						  out.println("<td>\n" +
		               "<div class=\"productcategory-card\">\n" +
		                 "<a href=\"productdetails.jsp?pageFrom=productcategory_ps4.jsp&productCategory="+product.get("ProductCategory")+"&productID="+product.get("ProductID")+"\">\n" +
