...
public class ProdCatAccessories extends HttpServlet {
		      ...
		      "<section>\n" +
		        "<div class=\"main\">\n" +
		          ...
		          "<div class=\"product-table\">\n" +
		            "<table>\n" +
		              "<caption><h1>Java Servlet Generated: Video Game Accessories</h1></caption>\n" +
		              "<thead>\n" +
		                "<tr>\n" +
		                  "<!--<th>Table Header</th>-->\n" +
		                "</tr>\n" +
 					...
 					String mainImage = imageLinksArray[0];
 					  ...
 					  p("<td>\n" +
	                    "<div class=\"productcategory-card\">\n" +
	                      "<a href=\"productdetails?pageFrom=productcategory_accessories&productCategory="+product.get("ProductCategory")+"&productID="+product.get("ProductID")+"\">\n" +
